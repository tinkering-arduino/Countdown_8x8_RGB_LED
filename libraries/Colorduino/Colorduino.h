 ...
 *   G: the value of GREEN. Range:GREEN 0~255
 *   B: the value of BLUE.  Range:BLUE 0~255
 *********************************************************/
 ...
 *   ColorFillMask
 * Function:
 *   Fill the frame with a mask
 * Parameter:
 *   mask: the mask for filling
 *   R: the value of RED.   Range:RED 0~255
 *   G: the value of GREEN. Range:GREEN 0~255
 *   B: the value of BLUE.  Range:BLUE 0~255
 *********************************************************/
  void ColorFillMask(unsigned char* mask, unsigned char R,unsigned char G,unsigned char B);
